    ...
    public void load() {
        ...
        try {
            ...
            while (RS.next()) {
                ...
                Monster monster = new Monster(id, gfxID, align, colors, grades, spells, stats, statsInfos, pdvs, pts, inits, mK, MK, xp, IAType, capturable, aggroDistance,type,name);
        ...
        try {
            ...
            while (RS.next()) {
                ...
                if (World.world.getMonstre(id) == null) {
                    World.world.addMobTemplate(id, new Monster(id, gfxID, align, colors, grades, spells, stats, statsInfos, pdvs, pts, inits, mK, MK, xp, IAType, capturable, aggroDistance,type,name));
                } else {
