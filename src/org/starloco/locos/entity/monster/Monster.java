...
//--------------------additional variables 
  ...
  public void setName(String name) {
    ...
    public Monster(int id, int gfxId, int align, String colors,
                   ...
                   boolean capturable, int aggroDistance, int type, String name) {
        this.id = id;
        this.gfxId = gfxId;
        this.align = align;
        this.colors = colors;
    ...
    public void addDrop(final Drop drop) {
        ...
        if(World.world.getObjTemplate(drop.getObjectId()) != null)
        	World.world.getObjTemplate(drop.getObjectId()).addMobQueDropea(id);
        drops.add(drop);
        drops.trimToSize();
    }
    public void borrarDrop(final int id) {
        ...
        if (remove != null) {
            World.world.getObjTemplate(id).delMobQueDropea(id);
            drops.remove(remove);
        }
    }
